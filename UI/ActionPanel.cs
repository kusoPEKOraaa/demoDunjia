...
{
    [Signal] public delegate void ActionSelectedEventHandler(int action);
    ...
    public override void _Ready()
    {
        ...
        _attack.Pressed += () => EmitSignal(SignalName.ActionSelected, (int)CombatActionType.Attack);
        _charge.Pressed += () => EmitSignal(SignalName.ActionSelected, (int)CombatActionType.Charge);
        _defend.Pressed += () => EmitSignal(SignalName.ActionSelected, (int)CombatActionType.Defend);
    }
